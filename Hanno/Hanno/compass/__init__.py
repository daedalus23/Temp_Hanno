...
class hmc5883l:
    ...
    def axes(self):
        ...
        data = self.bus.read_i2c_block_data(0x3D, 0x06)
        # print(data)
...
if __name__ == "__main__":
    ...
    compass = hmc5883l(gauss=5.6, declination=(14, 56))
    while True:
        x, y, z = compass.axes()
        sys.stdout.write(f"""\rHeading: {str(compass.degrees(compass.heading()))}\tx: {x}\t y: {y}\t z: {z}""")
        sys.stdout.flush()
        time.sleep(0.5)
